        ...
        <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse  first-level">
                    ...
                    <li class="sidebar-item">
                      <a href="{{ route('StudentDetails') }}" class="sidebar-link">
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse  first-level">
                  <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                      <a href="{{ route('BranchesDetails') }}" class="sidebar-link">
                          <span class="hide-menu"> Branch Details</span>
                      </a>
                  </li>
              </ul>
          </li>
           ...
           <li class="sidebar-item">
            ...
            <ul aria-expanded="false" class="collapse  first-level">
                <li class="sidebar-item">
                    <a href="{{ route('Addcourses') }}" class="sidebar-link">
                        <span class="hide-menu">Add courses</span>
                    </a>
                    <a href="{{ route('ShowCourse') }}" class="sidebar-link">
                      <span class="hide-menu"> courses Details</span>
                  </a>
